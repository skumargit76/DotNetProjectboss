<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FTUploadedFileEnquiry.aspx.cs" Inherits="Mboss.Web.FTUpload.FTUploadedFileEnquiry" %>
        ...
        <div class="container-fluid">
         ...
         <div class="span12">
                 <asp:Label runat="server" ID="lblFromDate" Text="Date From"></asp:Label>
                    <asp:TextBox ID="txtFromDate" runat="server" Width="108px"></asp:TextBox>
                 &nbsp;<asp:Label runat="server" ID="lblRndDate" Text="Date To"></asp:Label>
                    <asp:TextBox ID="txtToDate" runat="server" Width="108px"></asp:TextBox>
                 ...
                 &nbsp;
                 <asp:Button ID="btnFilter" runat="server" Text="Filter"  OnClick="btnFilter_Click" Height="33px" Width="74px" />
         </div>
            <hr />
