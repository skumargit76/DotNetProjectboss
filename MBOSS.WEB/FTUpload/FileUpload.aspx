<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUpload.aspx.cs" Inherits="Mboss.Web.FTUpload.FileUpload" %>
    ...
    <form id="mainForm" runat="server">     
            ...
            <div class="span12">
                <div class="span12" runat="server" id="tableR" visible="false" style="height:400px; overflow:scroll;" >
                     <table id="uploadedDataTable" class="table table-striped table-bordered" tabindex="4">
                         ...
                         <tfoot>
                            <tr>
                                <th colspan="17" style="text-align:right;"><asp:Button ID="btnSubmit" CssClass="btn btn-danger" Text="&#10004; Submit" TabIndex="5" runat="server" Enabled="false" OnClick="btnSubmit_Click" /></th>
                            </tr>   
                             </tfoot>
                            <tbody>
                           ...
                           <asp:Repeater ID="uploadedDataRepeater" runat="server">
                                ...
                                <td><%# string.Format("{0:yyyy/MMM/d}",Eval("debitValueDate")) %> </td>
                                ...
                                <td><%# Eval("creditValueDate", "{0:d/m/yy}") %> </td>
        ...
        <script type="text/javascript">
            ...
            function submit() {
                ...
                $(".ui-dialog-title").text("MBOSS - SUCCESS");
            ...
            function alreadySubmit() {
                ...
                $(".ui-dialog-title").text("MBOSS - ERROR");
